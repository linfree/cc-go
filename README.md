...
| 仪表盘 | 会话列表 |
|:---:|:---:|
| ![仪表盘](docs/screenshots/dashboard.png) | ![会话列表](docs/screenshots/sessions.png) |

| 会话聊天 | 微信绑定 |
|:---:|:---:|
| ![会话聊天](docs/screenshots/chat.png) | ![微信绑定](docs/screenshots/wechat.png) |

| 系统设置 | 日志 | 微信客户端 |
|:---:|:---:|:---:|
| ![系统设置](docs/screenshots/setting.png) | ![日志](docs/screenshots/logs.png) | ![微信客户端](docs/screenshots/wechat_client.png) |
